...
export default function Footer() {
  return (
    <div className="text-[#334155] flex flex-col text-center sm:text-left sm:flex-row items-center justify-between py-6 px-4 md:px-32 bg-slate-50 mt-auto gap-4 shadow-top-md">
      <div>
